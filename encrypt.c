...
//----- (0008930C) --------------------------------------------------------
unsigned char* sub_8930C(unsigned char* result)
{
	int v1; // r10@1
	int v2; // r2@1
	int v3; // r1@1
...
//----- (0008B2F4) --------------------------------------------------------
unsigned char* sub_8B2F4(unsigned char* result)
{
	int v1; // r4@1
	int v2; // r10@1
	int v3; // r9@1
...
//----- (0008D114) --------------------------------------------------------
unsigned char* sub_8D114(unsigned char* result)
{
	int v1; // r5@1
	int v2; // r6@1
	int v3; // r4@1
...
//----- (0008F0B0) --------------------------------------------------------
unsigned char* sub_8F0B0(unsigned char* result)
{
	int v1; // r7@1
	int v2; // r5@1
	int v3; // r12@1
...
//----- (000910A8) --------------------------------------------------------
unsigned char* sub_910A8(unsigned char* result)
{
	int v1; // r1@1
	int v2; // ST08_4@1
	int v3; // r10@1
...
//----- (00092E08) --------------------------------------------------------
unsigned char* sub_92E08(unsigned char* result)
{
	int v1; // r3@1
	int v2; // r5@1
	int v3; // ST34_4@1
...
//----- (00094BDC) --------------------------------------------------------
unsigned char* sub_94BDC(unsigned char* result)
{
	int v1; // r7@1
	int v2; // r5@1
	int v3; // ST04_4@1
...
//----- (00096984) --------------------------------------------------------
unsigned char* sub_96984(unsigned char* result)
{
	int v1; // r2@1
	int v2; // ST60_4@1
	int v3; // r3@1
...
//----- (000985E0) --------------------------------------------------------
unsigned char* sub_985E0(unsigned char* result)
{
	int v1; // r11@1
	int v2; // r3@1
	int v3; // r1@1
...
//----- (0009A490) --------------------------------------------------------
unsigned char* sub_9A490(unsigned char* result)
{
	int v1; // r7@1
	int v2; // r5@1
	int v3; // r2@1
...
//----- (0009C42C) --------------------------------------------------------
unsigned char* sub_9C42C(unsigned char* result)
{
	int v1; // r7@1
	int v2; // r2@1
	int v3; // r5@1
